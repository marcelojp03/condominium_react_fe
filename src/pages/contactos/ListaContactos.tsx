...
import {ContactosService,IListaContactos} from '../../shared/services/api/contactos/ContactosService';
...
export const ListaContactos: React.FC = () => {
  const [searchParams, setSearchParams] = useSearchParams();
  const { debounce } = useDebounce();
  const navigate = useNavigate();

  const [rows, setRows] = useState<IListaContactos[]>([]);
  ...
  useEffect(() => {
    ...
    debounce(() => {
      ContactosService.getAll(pagina,busca)
        .then((result) => {
          setIsLoading(false);

...
import { ITallasList, TallasService } from "../../shared/services/api/tallas/TallasService";

export const TallasList: React.FC = () => {
    const [searchParams, setSearchParams] = useSearchParams();
    const { debounce } = useDebounce();
    const navigate = useNavigate();
  
    const [rows, setRows] = useState<ITallasList[]>([]);
    ...
    useEffect(() => {
      ...
      debounce(() => {
        TallasService.getAll(pagina,busca)
          .then((result) => {
            setIsLoading(false);

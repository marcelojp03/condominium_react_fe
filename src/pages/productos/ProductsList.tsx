...
export const ProductsList: React.FC = () => {
  ...
  const busca = useMemo(() => {
    let idf="pages::cidades::Lista::useMemeo::busca::";
  ...
  const pagina = useMemo(() => {
    let idf="pages::cidades::Lista::useMemeo::pagina::";
    console.log(idf + "searchParams:",searchParams);
    console.log(idf + "totalCount:",totalCount);
  ...
  useEffect(() => {
    let idf="pages::cidades::Lista::useEffect::"
    ...
    <LayoutBaseDePagina
      ...
      barraDeFerramentas={
        <FerramentasDaListagem
          ...
          aoClicarEmNovo={() => navigate('/productos/detalle/nuevo')}

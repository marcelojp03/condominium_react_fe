...
export const FacesList: React.FC = () => {
  ...
  return (
    <LayoutBaseDePagina
      titulo='Reconocimientos faciales'
      barraDeHerramientas={
        <FerramentasDaListagem
          mostrarInputBusca
          textoDaBusca={busca}
          textoBotaoNovo='Nuevo'
          aoClicarEmNovo={() => navigate('/faces/detalle/nuevo')}
        ...
        {rows.map(row => (
          <TableRow key={row.idaviso}>
            ...
            <TableCell>
              ...
              <IconButton size="small" onClick={() => navigate(`/faces/detalle/${row.idaviso}`)}>
                <Icon>edit</Icon>
              </IconButton>
            </TableCell>
          </TableRow>

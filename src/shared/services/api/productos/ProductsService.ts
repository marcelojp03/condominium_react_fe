...
export interface IProductDetail {
  ...
  status: boolean;
  genderId: number;
  sizes?: number[];  // Ids de las tallas disponibles
...
const create = async (dados: Omit<IProductDetail, 'id'>): Promise<number| any | Error> => {
  let idf='cidadesServide::create::';
  let ciudad:IProductDetail;
...
const updateById = async (id: number, dados: IProductDetail): Promise<void | Error> => {
